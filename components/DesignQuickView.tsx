...
/**
 * DesignQuickView — Smileyque2-style full-page overlay adapted for Fashion Designer.
 *
 * Layout:
...
const TAB_CONTENT: Record<Tab, string> = {
  'Description':
    'Each Fashion Designer piece is crafted to order with your exact measurements taken during consultation. Our master tailors use only premium fabrics sourced from trusted suppliers, ensuring a bespoke fit that is uniquely yours.',
  'Details & Care':
              ...
              >
                ...
                <div className="flex-1">
                  ...
                  <p className="font-inter text-[11px] text-charcoal/60 mt-0.5 leading-relaxed">
                    Fashion Designer sources premium fabric &amp; handles everything — cutting, sewing &amp; finishing.
                  </p>
                </div>
